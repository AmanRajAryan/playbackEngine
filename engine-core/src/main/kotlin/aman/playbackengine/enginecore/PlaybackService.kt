...
class PlaybackService : BasePlaybackService() {
    ...
    override fun onTaskRemoved(rootIntent: Intent?) {
        ...
        val audioEffectivelyDead = audioPolicy == TaskRemovedPolicy.RELEASE || !PlaybackManager.audio.isPlaying.value
        val videoEffectivelyDead = videoPolicy == TaskRemovedPolicy.RELEASE || !PlaybackManager.video.isPlaying.value
