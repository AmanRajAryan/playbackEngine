...
object PlaybackManager {
    ...
    /**
     * Unified Global Equalizer.
     * Manages DSP bands dynamically mapped to device hardware capabilities.
     */
    val equalizer: aman.playbackengine.enginecore.equalizer.PlaybackEqualizer = aman.playbackengine.enginecore.equalizer.EqualizerManager
    ...
    internal fun internalInit(context: Context) {
        ...
        aman.playbackengine.enginecore.equalizer.EqualizerManager.init(appContext)
        aman.playbackengine.enginecore.internal.persistence.PlaybackSettingsManager.init(appContext)
        isInitialized = true
    }
