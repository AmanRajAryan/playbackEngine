...
dependencies {
    ...
    implementation("io.github.amanrajaryan:playback-engine-core:1.0.1")

    // Engine implementations (pick one or both)
    implementation("io.github.amanrajaryan:playback-engine-exoplayer:1.0.1")
    implementation("io.github.amanrajaryan:playback-engine-mpv:1.0.1")
}
```
...
Adjust tempo and pitch dynamically:
```kotlin
