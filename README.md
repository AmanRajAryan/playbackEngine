...
dependencies {
    ...
    implementation("io.github.amanrajaryan:playback-engine-core:1.0.2")

    // Engine implementations (pick one or both)
    implementation("io.github.amanrajaryan:playback-engine-exoplayer:1.0.2")
    implementation("io.github.amanrajaryan:playback-engine-mpv:1.0.2")
}
```
